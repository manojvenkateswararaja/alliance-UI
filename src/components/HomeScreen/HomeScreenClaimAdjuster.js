...
export default class HomeScreenClaimAdjuster extends Component {
    ...
    onSubmitExamineClaim(token,userType,publicadjusternegotiation) {
    ...
    render() {
        ...
        var publicadjusternegotiation = "Public-Adjuster Negotiation value";
        ...
        return (
            <ScrollView style={scrollContainer}>
                <View style={scrollViewContainer}>
                    ...
                    <TouchableOpacity 
                    activeOpacity={.5}
                    onPress={() => this.onSubmitExamineClaim(token,userType,publicadjusternegotiation)}>
